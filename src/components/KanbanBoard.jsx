  ...
  return (
    <div className="p-6 bg-gradient-to-r from-yellow-100 to-orange-200 min-h-screen text-black ">
      <menu className="absolute left-4 top-30 border-1 border-yellow-400 p-4 rounded-2xl w-60 bg-amber-100 shadow-lg flex flex-col gap-4">
        <h3 className="font-bold text-xl text-center text-yellow-800">
          📋 Menu Bar
        </h3>
        ...
        {/* Select Screen */}
        <select className="border px-2 py-1 rounded text-sm hover:cursor-pointer">
          {screens.map((screen, idx) => (
            <option key={idx} className="hover:cursor-pointer">
              {screen}
            </option>
          ))}
        </select>
